      ...
      <StyleBackground $bg_image={about_image?.url} className="about">
        <div className="about-container container mx-auto">
          <div className="about-first_block">
            <h2 className="about-subtitle green-color">{asText(about_title)}</h2>
          ...
          <div className="about-second_block relative">
            ...
            />
            <h2 className="about-subtitle green-color">{asText(sub_title_one)}</h2>
          ...
          <div className="about-third_block relative">
            <h2 className="about-subtitle green-color">{asText(sub_title_two)}</h2>
          ...
          <div className="about-fourth_block">
            <h2 className="about-subtitle green-color">{asText(sub_title_group_three)}</h2>
